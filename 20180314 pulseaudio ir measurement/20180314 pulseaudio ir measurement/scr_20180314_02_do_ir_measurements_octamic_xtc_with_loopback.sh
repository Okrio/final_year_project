...
NUM_PLAY_CHANNELS=4
#STIMULUS_FILE=sweptsine_20_24000_0.6_48000_stereo.wav
STIMULUS_FILE=sweptsine_20_24000_0.6_48000.wav
#STIMULUS_FILE=sweptsine_20_24000_0.6_48000_chans1and3.wav
...
#paplay --device=$PLAY_DEVICE --channels=$NUM_PLAY_CHANNELS --channel-map=$PLAY_CHANNELMAP --volume=49152 $STIMULUS_FILE
...
#paplay --device=$PLAY_DEVICE  --volume=49152 $STIMULUS_FILE
#paplay --device=$PLAY_DEVICE  $STIMULUS_FILE
